...
function useVerificacion() {
    ...
    const revisar = async (email)=>{
        ...
        setError(null);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkVerificationStatus"])(email);
            setEstado(data);
        } catch (err) {
...
_s(useVerificacion, "Yg6b2dqAkEb1IRr4xFIAHg2/oys=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(VerificacionStatus, "dkm3z4wTksWmbL7T5unTfw5bn7k=", false, function() {
    return [
...
//# sourceMappingURL=src_a5d3cb21._.js.map